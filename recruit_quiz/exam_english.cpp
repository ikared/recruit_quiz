...
QuestionList CreateEnglishPhraseExam()
{
	const struct {
		...
		3, {1, 2, 5}},
		{ "it is not until [A] that [B]", "[A]して始めて[B]をする",
		...
		"We have neither the time nor the resources.", "我々には時間も資金もない。",
		2, {3, 6}},
